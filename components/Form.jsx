...
const Form = ({ type, post, setPost, submitting, handleSubmit }) => {
	...
	const deletePictureFromStorage = (delUrl) => {
          ...
          /> */}
                ...
                `}
					...
					{post.image && (
						<div className="relative">
							<Edit
								onClick={() =>
									deletePictureFromStorage(post.image)
								}
				...
				<label>
					<span className="font-satoshi font-semibold text-base text-gray-700">
						Make{" "}
						<span className="font-normal">
							(Please add make of vehicle.)
						</span>
					</span>
					<input
						value={post.make}
						onChange={(e) =>
							setPost({ ...post, make: e.target.value })
						}
						type="text"
						placeholder="Make"
						required
				...
				<label>
					<span className="font-satoshi font-semibold text-base text-gray-700">
						Model{" "}
						<span className="font-normal">
							(Please add model of vehicle.)
						</span>
					</span>
					<input
						value={post.model}
						onChange={(e) =>
							setPost({ ...post, model: e.target.value })
						}
						type="text"
						placeholder="Model"
						required
          ...
          /> */}
				...
				<label>
					...
					<input
						...
						onChange={(e) =>
							setPost({ ...post, startingODO: e.target.value })
						}
						type="text"
				...
				<label>
					<span className="font-satoshi font-semibold text-base text-gray-700">
						Notes{" "}
						<span className="font-normal">
							(Please add notes to vehicle.)
						</span>
					</span>
					<input
						value={post.notes}
						onChange={(e) =>
							setPost({ ...post, notes: e.target.value })
						}
						type="text"
						placeholder="Notes"
						required
